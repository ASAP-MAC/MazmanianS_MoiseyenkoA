...
ggsave(plot = plots_as_facets, filename = file.path(params$basic_outdir, params$humann_data_type, cohort_subdir, "fermentative_pathways_panel.svg"), height=8, width = 8)
...
maaslin3_final_outdir <- file.path(params$basic_outdir, params$humann_data_type, cohort_subdir, maaslin3_expmt)
