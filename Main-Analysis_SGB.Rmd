...
Microbiome_Main_Figure <- ggarrange(
  ...
  ggarrange(
    ...
    widths = c(1, 0.05, 0.85), nrow = 1, labels = c("D", "E",  "")
    ),
...
GTDB.df[match(taxaNames_no_UN_no_Prefix, GTDB.df$SGB),] %>% 
  write_tsv(file = file.path(params$basic_outdir, params$microbiome_data_type, sprintf("Supplementary Table %i - GTDB taxonomy of the study.tsv", tableIndex)))
