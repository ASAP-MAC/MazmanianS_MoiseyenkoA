...
# copy their standard plot in
invisible(file.copy(file.path(maaslin3_tmp_outdir, "figures", "summary_plot.png"), file.path(maaslin3_final_outdir, "summary_plot.png")))
```

####  Maaslin3 default plot

```{r}
knitr::include_graphics(file.path(maaslin3_final_outdir, "summary_plot.png"))
```
...
# Bacteroides/Firmicutes ratio plot
