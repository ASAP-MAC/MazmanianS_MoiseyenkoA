...
microbiome_panel_MainText <- ggarrange(
  panelA_stackplot + theme(legend.position = "top") + guides(fill = guide_legend(ncol = 2, title = NULL)),
    ggarrange(
      get_legend(panelB_PCoA),
      ggarrange(
        panelB_PCoA + theme(legend.position = "none"), 
        panelC_pairwise_dissim_boxplot,
        ncol = 2, widths = c(1, 0.7), align = "h", labels = c("b", "d")
        ),
      # panelF_FB.Ratio_horiz + theme(legend.position = "none") + coord_flip(), 
      ncol= 1,
      heights = c(0.05, 1, 0.8), 
      labels = c("", "", "c")
      ),
    widths = c(0.6, 1),
  labels = c("a", "")
...
microbiome_panel_MainText <- ggarrange(
  panelA_stackplot + theme(legend.position = "top") + guides(fill = guide_legend(ncol = 2, title = NULL)),
    ggarrange(
      ...
      ggarrange(
        panelB_PCoA + theme(legend.position = "none"), 
        panelF_FB.Ratio + theme(legend.position = "none"), 
        ncol = 2, widths = c(1, 0.7), align = "h", labels = c("b", "d")
        ),
      panelC_pairwise_dissim_boxplot_horiz,
      ncol= 1,
      heights = c(0.05, 1, 0.8), 
      labels = c("", "", "c")
      ),
