...
bead_expulsion.df <- openxlsx::read.xlsx("Data/motor_performance/Fp7_raw.xlsx", sheet = "Bead_exp") %>% 
  dplyr::select(mouse_id = ID, bead_expulsion_min = Trial1)
...
slips_over_step.df <- openxlsx::read.xlsx("Data/motor_performance/Fp7_raw.xlsx", sheet = "Beam_steps") %>% 
  transmute(mouse_id = ID,
            slips_over_steps = Slips_Trial1/Steps_Trial1)
...
write_tsv(data_as_long_table, file = file.path(params$basic_outdir, params$tax_level, cohort_subdir, "PCo1-3_mediation_slips_over_steps_ASO_treat_vs_ASO_ctrl.tsv"))
```
...
write_tsv(data_as_long_table, file = file.path(params$basic_outdir, params$tax_level, cohort_subdir, "PCo1-3_mediation_bead_expulsion_min_ASO_treat_vs_ASO_ctrl.tsv"))
```
