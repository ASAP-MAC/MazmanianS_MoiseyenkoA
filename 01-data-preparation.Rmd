...
# re-derive tranformations
assay(HUMAnN_pathways_unstratified.tse, "gene_family_abundance_rpk_relab_unstratified") <- apply(assay(HUMAnN_pathways_unstratified.tse), 2, function(x) x/sum(x))
assay(HUMAnN_pathways_unstratified.tse, "gene_family_abundance_rpk_cpm_unstratified") <- apply(assay(HUMAnN_pathways_unstratified.tse), 2, function(x) x/sum(x)*10^6)
```
